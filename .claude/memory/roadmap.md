...
| 9 | Iterate (≤10) | `12-leaderboard-improvement` | 🟡 active | Baseline 0.449. Next: calibrate spend vs balance/borrow weighting (controlled, business-justified; guard public-70% overfit). |
