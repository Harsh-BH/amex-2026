...
|---|------|---------------------|-----------|-----------|-----------|-------|
| 1 | 2026-06-28 | Interpretable CM framework beats naive spend on top-20% overlap; get baseline signal | v1.1 weights → `submission_v1_baseline.xlsx` (built + validated, **not yet uploaded**) | _pending upload_ | (hidden until R1 end) | — |
