"""Build data/scores_v31.csv — v31 'recovered-consensus-r2' (the 19-constraint refit's consensus).
...
Run: .venv/bin/python scratchpad/build_v31.py
"""
...
# profile of the members v31 bets on vs v27 (the economic story of the correction)
gain = top & ~v27
lose = v27 & ~top
